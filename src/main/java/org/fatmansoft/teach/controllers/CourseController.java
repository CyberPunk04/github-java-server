...
/**
    ...
    public Map getMapFromCourse(Course c) {
        ...
        m.put("courseCredit", c.getCredit());
...
/**
    ...
    public DataResponse getCourseInfo(@Valid @RequestBody DataRequest dataRequest) {
        Integer courseId = dataRequest.getInteger("coureId");
        Course c = null;
        Optional<Course> op;
        if(courseId != null) {
...
//        p.setName(CommonMethod.getString(form,"name"));
        ...
        c.setCourseStatus(CommonMethod.getString(form,"status"));
        c.setCourseRemark(CommonMethod.getString(form,"remark"));
        c.setCourseDesc(CommonMethod.getString(form," description"));
